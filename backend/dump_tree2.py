...
out = {}
out["SmartStorage"] = client.get("/redfish/v1/Systems/1/SmartStorage/")
out["PCIDevices"] = client.get("/redfish/v1/Systems/1/PCIDevices/")
out["Power"] = client.get("/redfish/v1/Chassis/1/Power/")
