...
out = {}
out["ArrayControllers"] = client.get("/redfish/v1/Systems/1/SmartStorage/ArrayControllers/")
if out["ArrayControllers"]:
    for m in out["ArrayControllers"].get("Members", []):
        uri = m.get("@odata.id")
        out[uri] = client.get(uri)

out["FirmwareInventory"] = client.get("/redfish/v1/Systems/1/FirmwareInventory/")
